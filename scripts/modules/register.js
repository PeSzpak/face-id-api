...
export class RegisterManager {
    ...
    setupSection() {
        ...
        startBtn.onclick = () => this.startCamera(video, startBtn, captureBtn, statusDiv);
        stopBtn.onclick = () => this.stopCamera(video, startBtn, captureBtn, statusDiv);
        captureBtn.onclick = () => this.captureAndRegister(video, nameInput, statusDiv);
    }
