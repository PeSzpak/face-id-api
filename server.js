...
// MongoDB connection
mongoose.connect(process.env.MONGODB_URL.replace('<db_password>', 'YOUR_PASSWORD_HERE'))
...
app.get('/api/faces', async (req, res) => {
  try {
    const faces = await Face.find({}, 'name recognitionCount lastSeen registeredAt');
    res.json({ faces });
  } catch (error) {
